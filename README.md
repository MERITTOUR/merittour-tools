...
│   ├── inquiry/index.html  ← 예약가능일자 안내 도구 (v1.2)
│   ├── aligo/              ← (Aligo 알림톡 도구, 추후)
│   └── saizen/             ← (SaiZen v13.4, 추후)
│
...
| `https://merittour.github.io/merittour-tools/sales/` | 영업·항공·관리 직원 | 영업 도구 + 참고 자료 |
...
A. 네. 직원 명함은 이제 `https://merittour.github.io/merittour-tools/cards/{이름}.png`로 호스팅됩니다. 메일 서명에 임베드된 이미지 URL을 새 경로로 변경해야 합니다.
